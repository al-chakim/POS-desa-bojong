                            ...
                            <div class="col-12 mt-4">
                                <table class="table-payment-2">
                                    <tr>
                                        ...
                                        <td hidden=""><input type="text" class="nilai-subtotal2-td"
                                                name="subtotal" value="0"></td>
                                    </tr>
                                    <tr>
                                        <td class="text-left">
                                    ...
                                    <tr>
                                        ...
                                        <td hidden=""><input type="text" class="nilai-total2-td" name="total"
                                                value="0"></td>
                                    </tr>
                                </table>
                            </div>
