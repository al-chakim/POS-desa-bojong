                            ...
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuIconButton1">
                                        <a class="dropdown-item chart-filter" href="#" data-filter="minggu">1
                                            Minggu Terakhir</a>
                                        <a class="dropdown-item chart-filter" href="#" data-filter="bulan">1 Bulan
                                            Terakhir</a>
                                        <a class="dropdown-item chart-filter" href="#" data-filter="tahun">1 Tahun
                                            Terakhir</a>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <table class="table table-custom">
                                            ...
                                            @foreach ($transactions as $transaction)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <button class="btn btn-selengkapnya font-weight-bold"
                                                            type="button"
                ...
                datasets: [{
                    ...
                    data: [
                        @if (count($incomes) != 0)
                            @foreach ($incomes as $income)
                                @php
                                    $total = \App\Transaction::whereDate('created_at', $income)->sum('total');
                                @endphp
                                    "{{ $total }}",
                            @endforeach
                        @endif
